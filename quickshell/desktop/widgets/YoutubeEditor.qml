...
Item {
    ...
    function pickLayout(value) {
        WidgetsService.setYoutubeLayout(index, value)
        layout = value
    }
    ...
    Column {
            ...
            Flow {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        height: 32
                        radius: 9
                        color: editor.layout === value ? Qt.rgba(0.30, 0.52, 0.95, 0.9)
        ...
        Text {
            width: parent.width
            text: "The download folder is shared by all YouTube widgets. Click its path in any layout to change it."
