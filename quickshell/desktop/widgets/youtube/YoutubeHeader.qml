...
Item {
    ...
    Row {
        ...
        Rectangle {
            ...
            radius: compact ? 6 : 7
            color: "#ff0033"
            Text { anchors.centerIn: parent; text: "▶"; color: "#ffffff"; font.pixelSize: compact ? 9 : 11 }
        }
        Text {
            anchors.verticalCenter: parent.verticalCenter
            text: compact ? "YouTube" : "YouTube Downloader"
    ...
    Rectangle {
        ...
        Row {
            ...
            Text {
                ...
                text: widget.service.outputDir || "Downloads/YouTube"
                color: widget.secondary
