    ...
    Item {
        ...
        Row {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        font.pixelSize: widget.service.inspecting ? 10 : 24
                    }
                }
                Column {
            ...
            Column {
                ...
                spacing: 6
                YoutubeModeSelector { width: parent.width; height: 30; widget: view.widget }
                Row {
                    width: parent.width
                    spacing: 7
                    YoutubeCombo {
                ...
                Text {
                    ...
                    text: widget.service.busy
                        ...
                        : (widget.sourceLine() || widget.service.cookieStatus(widget.cookieBrowser))
