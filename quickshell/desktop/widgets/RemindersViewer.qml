...
Item {
    ...
    function toggle(i) {
        if (i < 0 || i >= lm.count)
            return;
        lm.setProperty(i, "done", !lm.get(i).done);
        persist();
    }
    ...
    ListView {
        ...
        WheelHandler {
            ...
            onWheel: ev => {
                lvGlide.stop();
                if (Kinetic.onWheel(lv, ev, lv._ks, {
                    gain: 44
                }))
                    lvEndTimer.restart();
            }
        ...
        delegate: MouseArea {
            ...
            Rectangle {
                ...
                height: dragArea.height - 2
                radius: 8
                anchors.horizontalCenter: parent.horizontalCenter
                anchors.verticalCenter: parent.verticalCenter
                color: dragArea.held ? Qt.rgba(1, 1, 1, 0.16) : (rowHover.hovered ? Qt.rgba(1, 1, 1, 0.06) : "transparent")
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: vw.toggle(dragArea.visualIndex)
                    }
                }
                Text {
                ...
                Text {
                    ...
                    text: "\uf1f8"
                    color: trashHover.hovered ? "#ff5b5b" : Qt.rgba(1, 1, 1, 0.4)
                    font.family: ThemeService.iconFont
                    font.pixelSize: 14
                    HoverHandler {
                        id: trashHover
                    ...
                    MouseArea {
                        ...
                        anchors.margins: -6
                        cursorShape: Qt.PointingHandCursor
                        onClicked: vw.removeItem(dragArea.visualIndex)
                    }
                }
