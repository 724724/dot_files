...
Singleton {
    ...
    readonly property color surface: isDark ? Qt.rgba(28 / 255, 28 / 255, 30 / 255, 0.75)
                                            : Qt.rgba(242 / 255, 242 / 255, 247 / 255, 0.75)
    readonly property color surfaceStrong: isDark ? Qt.rgba(44 / 255, 44 / 255, 46 / 255, 0.75)
                                                  : Qt.rgba(1, 1, 1, 0.75)
    readonly property color surfaceStroke: isDark ? Qt.rgba(1, 1, 1, 0.08)
                                                  : Qt.rgba(0, 0, 0, 0.06)
